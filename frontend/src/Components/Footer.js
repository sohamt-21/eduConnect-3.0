...
const Footer = () => {
    ...
    return (
        <div style={{ height: "500px", backgroundColor: "transperent", padding: "30px", marginLeft: "auto", marginRight: "auto", fontSize: "large", maxWidth: "100%", color: "#E8D8C4" }} >
            <hr style={{width:'90%'}}/>
            <div className="footercontainer">
                ...
                <div className="footersecond">
                    <h2>For Users</h2>
                    <li id='footerli'>
                        <a id='footera'href="/apply">Portal</a>
