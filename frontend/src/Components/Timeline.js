        ...
        <VerticalTimeline>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Register} alt="" style={{ width: '100px', height: '100px' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Verify} alt="" style={{ width: '80px', height: '80px'}} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={NFT} alt="" style={{ width: '80px', height: '80px' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Login} alt="" style={{ width: '80px', height: '80px' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={SwitchUser} alt="" style={{ width: '80px', height: '80px',borderRadius:'50%' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Announcement} alt="" style={{ width: '75px', height: '75px',marginRight:'10px' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Chat} alt="" style={{ width: '80px', height: '80px' }} />
                    </div>
                    <div>
            ...
            >
                <div className='gradientDiv' style={{ display: 'flex', flexDirection: 'row' }}>
                    <div>
                        <img src={Ban} alt="" style={{ width: '80px', height: '80px' }} />
                    </div>
                    <div>
